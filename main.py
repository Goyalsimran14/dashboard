...
#     # Sidebar Section with Enhanced CSS
#     st.sidebar.markdown("""
#         <style>
#             .sidebar-container {
...
#                 /* Make sidebar text more compact and mobile-friendly */
# `           @media screen and (max-width: 768px) {
#              section[data-testid="stSidebar"] {
#             width: 100% !important;
#             max-width: 100% !important;
...
#             /* Adjusting resource links spacing */
#             .expander-content a {
#                 display: block;
#                 padding: 4px 0;
#                 font-size: 0.95rem;
...
#             /* Input and progress dropdown width */
...
#                     pdf_path = os.path.join("c:/Users/goyal/OneDrive/Desktop/dashboard", pdf["path"])
#                     st.markdown(f"- [{pdf['name']}]({pdf_path})")
